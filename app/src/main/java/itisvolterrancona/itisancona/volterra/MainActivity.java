...
import itisvolterrancona.itisancona.volterra.adapter.NavDrawerListAdapter;
import itisvolterrancona.itisancona.volterra.model.NavDrawerItem;
...
public class MainActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     // Linkedin, We  will add a counter here
        ...
        // enabling action bar app icon and behaving it.itisvolterrancona as toggle button
    ...
    /**
     * When using the ActionBarDrawerToggle, you must call it.itisvolterrancona during
